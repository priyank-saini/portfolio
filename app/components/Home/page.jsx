...
const page = () => {
  return (
    <div className="h-screen flex flex-col justify-between">
      <div className="navbar z-20 text-white pt-6 px-20 flex justify-between text-[24px] fixed w-screen bg-black sm:visible">
        {/*Navbar*/}
        {/* Left Part */}
      ...
      <div className="h-full flex flex-col gap-10 pt-[150px]">
        ...
        <div className="flex flex-col w-auto p-20 h-1/2">
          <p className="sm:text-5xl font-semibold text-[#7FE143] text-[25px]">
            Hi I&apos;m,
          </p>
